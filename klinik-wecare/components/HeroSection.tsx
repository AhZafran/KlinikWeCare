    ...
    <section className="relative overflow-hidden py-20 sm:py-28 lg:py-32">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="WeCare Clinic Team"
          fill
          className="object-cover"
          priority
        />
        {/* White overlay for opacity control */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
            ...
            <span className="text-[#283a67]">Desa Melawati</span>
          </h1>

          {/* Supporting Subtext */}
          <p className="mt-6 text-lg leading-8 text-gray-600 sm:text-xl">
            Professional medical care for you and your family.
            Experience friendly service, convenient location, and quality healthcare
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3 text-center">
            <div>
              <div className="text-3xl font-bold text-[#283a67]">10+</div>
              <div className="mt-1 text-sm text-gray-600">Years Experience</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#283a67]">1000+</div>
